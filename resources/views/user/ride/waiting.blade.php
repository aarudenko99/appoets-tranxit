    ...
    <script type="text/jsx">
				...
				<div>
		            ...
		            <br/>
		            	...
		            	<dl className="dl-horizontal left-right">
                            ...
                            <dd>{this.props.currency}{this.props.checkState.distance}</dd>
		...
		var DroppedAndCard = React.createClass({
			...
			render: function(){
				...
				<div>
					<div className="status">
                    	...
                    	<button onClick={this.onItemClick} type="button" className="full-primary-btn fare-btn">CONTINUE TO PAY - {this.props.currency}{this.props.checkState.payment.payable}</button>


						<form name='razorpayform' method="POST" action="{{url('/payment')}}">
							{{ csrf_field() }}</input>
			            	<input type="hidden" name="request_id" value={this.props.checkState.id} />
			...
			onItemClick: function (event) {
		        ...
		        var options = {
		            "key": "{{$razorpay_key}}",
		            "amount": this.props.checkState.payment.total * 100,
		            "name": "Flyer Wheels",
		            "description": "",
