            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dt class="col-sm-4">Provider Mobile :</dt>
                        @if($request->provider)
                        <dd class="col-sm-8">{{ $request->provider->mobile }}</dd>
                        @else
                        <dd class="col-sm-8">Provider not yet assigned!</dd>
                        @endif

                        <dt class="col-sm-4">Provider Email :</dt>
                        @if($request->provider)
                        <dd class="col-sm-8">{{ $request->provider->email }}</dd>
                        @else
                        <dd class="col-sm-8">Provider not yet assigned!</dd>
                        @endif

                        <dt class="col-sm-4">Service Type :</dt>
                        <dd class="col-sm-8">{{ $request->service_type ? $request->service_type->name : '-' }}</dd>

                        <dt class="col-sm-4">Total Distance :</dt>
                        <dd class="col-sm-8">{{ $request->distance ? $request->distance : '-' }}</dd>

                        <dt class="col-sm-4">ETA :</dt>
                        <dd class="col-sm-8">{{ $request->estimated_fare ? currency($request->estimated_fare) : '-' }}</dd>

                        @if($request->status == 'SCHEDULED')
                        <dt class="col-sm-4">Ride Scheduled Time :</dt>
                        <dd class="col-sm-8">
                            @if($request->schedule_at != null && $request->schedule_at != "0000-00-00 00:00:00")
                        ...
                        <dd class="col-sm-8">
                            @if($request->started_at != null && $request->started_at != "0000-00-00 00:00:00")
                        ...
                        <dd class="col-sm-8">
                            @if($request->finished_at != null && $request->finished_at != "0000-00-00 00:00:00") 
                        ...
                        <dd class="col-sm-8">{{ $request->otp ? $request->otp : '-' }}</dd>
                        ...
                        <dt class="col-sm-4">MINS Price :</dt>
