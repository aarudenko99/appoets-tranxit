...
class AdminController extends Controller
{
    ...
    public function settings_store(Request $request)
    {
        ...
        Setting::set('start_hour', $request->start_hour.":".$request->start_min);
        Setting::set('end_hour', $request->end_hour.":".$request->end_min); 
        Setting::save();
    ...
    public function settings_payment_store(Request $request)
    {
        ...
        $this->validate($request, [
                'CARD' => 'in:on',
                'CASH' => 'in:on',
                'razorpay_secret_key' => 'required_if:CARD,on|max:255',
                'razorpay_publishable_key' => 'required_if:CARD,on|max:255',
        ...
        Setting::set('razorpay_secret_key', $request->razorpay_secret_key);
        Setting::set('razorpay_publishable_key', $request->razorpay_publishable_key);
