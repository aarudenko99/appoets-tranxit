		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					...
					<span class="s-text">@lang('admin.include.location')</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.account-manager.index') }}">@lang('admin.include.list_locations')</a></li>
					<li><a href="{{ route('admin.account-manager.create') }}">@lang('admin.include.add_new_location')</a></li>
				</ul>
			</li>
