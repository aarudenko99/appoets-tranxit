...
<body class="fixed-sidebar fixed-header content-appear skin-default">
    ...
    <div id="request-notification" style="display: none;">
        <button id="to-dispatcher" class="btn btn-danger">Go to dispatcher panel</button>
        <a class="text-black" href="#">
            <div class="media">
                <div class="media-body">
                    <p class="mb-0-5">
                        <span class="request-name">Syed2 H</span>
                        <span class="tag tag-warning pull-right"> SEARCHING </span>
                    </p>
                    <h6 class="media-heading request-addrfrom">From: 1600 Amphitheatre Pkwy, Mountain View, CA 94043, USA</h6>
                    <h6 class="media-heading request-addrto">To: 1500 Charleston Rd, Mountain View, CA 94043, USA</h6>
                    <h6 class="media-heading request-payment">Payment: CASH</h6>

                    <span class="text-muted request-searchmode">Auto Search : 2019-06-20 14:55:36</span>
                </div>
            </div>
        </a>
    </div>
    ...
    <script type="text/javascript" src="{{asset('asset/js/request_notification.js')}}"></script>    
