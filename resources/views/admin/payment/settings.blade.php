                ...
                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                <input @if(Setting::get('CARD') == 1) checked  @endif  name="CARD" id="razorpay_check" onchange="cardselect()" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                        <div id="card_field" @if(Setting::get('CARD') == 0) style="display: none;" @endif>
                            <div class="form-group row">
                                <label for="razorpay_secret_key" class="col-xs-4 col-form-label">@lang('admin.payment.razorpay_secret_key')</label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="{{Setting::get('razorpay_secret_key', '') }}" name="razorpay_secret_key" id="razorpay_secret_key"  placeholder="RazorPay Secret key">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="razorpay_key" class="col-xs-4 col-form-label">@lang('admin.payment.razorpay_publishable_key')</label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="{{Setting::get('razorpay_publishable_key', '') }}" name="razorpay_publishable_key" id="razorpay_publishable_key"  placeholder="RazorPay Publishable key">
                                </div>
                            </div>
                        </div>
                    </blockquote>
